...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center py-28 text-center px-4">
      <div className="w-20 h-20 rounded-full bg-yellow-50 flex items-center justify-center mb-5 border border-yellow-100">
        <Megaphone className="w-9 h-9 text-yellow-400" />
      </div>
      <h3 className="text-lg font-semibold text-gray-600 mb-1">Belum Ada Pengumuman</h3>
      <p className="text-sm text-gray-400 max-w-xs">
        Pengumuman resmi dari dusun akan ditampilkan di sini.
      </p>
    </div>
  );
}
